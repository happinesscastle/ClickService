...
// Type: ClickServerService.ClickService
...
{
    public class ClickService : ServiceBase
    {
        ...
        {
            this.TempP1_DT.Clear();
            this.TempP1_DT.Columns.Clear();
            this.TempP1_DT.Rows.Clear();
            this.TempP1_DT.Columns.Add("Txt");
            this.WriteToFile("Service is started at " + (object)DateTime.Now);
            this.timer.Elapsed += new ElapsedEventHandler(this.OnElapsedTime);
            this.timer.Interval = 3000.0;
            this.timer.Enabled = true;
            this.timerChargeRate.Elapsed += new ElapsedEventHandler(this.timerChargeRate_Tick);
            this.timerChargeRate.Interval = 100.0;
            this.timerChargeRate.Enabled = false;
            this.timerChargeRate_SetNonRecive.Elapsed += new ElapsedEventHandler(this.timerChargeRate_SetNonRecive_Tick);
            this.timerChargeRate_SetNonRecive.Interval = 300000.0;
            this.timerChargeRate_SetNonRecive.Enabled = true;
            this.Timer_SendData.Elapsed += new ElapsedEventHandler(this.Timer_SendData_Tick);
            this.Timer_SendData.Interval = 1000.0;
            this.Timer_SendData.Enabled = true;
            this.objMain._pbNCStatus();
            this.AppLoadMain();
            this.Timer_Create_Repair_CheckList.Elapsed += new ElapsedEventHandler(this.Timer_Create_Repair_CheckList_Tick);
            this.Timer_Create_Repair_CheckList.Interval = 1800000.0;
            this.Timer_Create_Repair_CheckList.Enabled = true;
        }

        private void Timer_Create_Repair_CheckList_Tick(object sender, EventArgs e) => this.Create_Repair_CheckList();

        private void Create_Repair_CheckList() => new Thread(new ThreadStart(new RepairClass().Create_Repair_Today_CheckList)).Start();

        private void timerChargeRate_SetNonRecive_Tick(object sender, EventArgs e) => this.objSwiper.Swiper_StateUpdateToNotReciveForChargeRate();
        ...
        public void AppLoadMain()
        {
            try
            {
                ClickService.flagConnectToSQL = false;
                ClickService.cblValidateReceivedData = 2;
                ClickService.chbAP1 = false;
                ClickService.chbAP2 = false;
                ClickService.txtAp1_IP = "0.0.0.0";
                ClickService.txtAp2_IP = "0.0.0.0";
                ClickService.txtServerIp = "0.0.0.0";
                ClickService.cblRepeatConfig = 2;
                ClickService.chbShowAllRecive = true;
                ClickService.txtRecive = "";
                ClickService.chbShowAllSend = true;
                ClickService.txtSend = "";
                ClickService.chbDecreasePriceInLevel2 = false;
                ...
                else
                {
                    ...
                    ClickService.Main_ID_GameCenter = this.objMain.ID_GameCenter_Local_Get();
                    ...
                    {
                        ClickService.txtServerIp = byGameCenter.Rows[0]["ServerIP"].ToString();
                        ClickService.chbAP1 = Convert.ToBoolean(byGameCenter.Rows[0]["IsEnableAP1"].ToString());
                        ClickService.txtAp1_IP = byGameCenter.Rows[0]["AP1_IP"].ToString();
                        ClickService.chbAP2 = Convert.ToBoolean(byGameCenter.Rows[0]["IsEnableAP2"].ToString());
                        ClickService.txtAp2_IP = byGameCenter.Rows[0]["AP2_IP"].ToString();
                        ClickService.cblRepeatConfig = int.Parse(byGameCenter.Rows[0]["RepeatConfig"].ToString());
                        ClickService.cblValidateReceivedData = int.Parse(byGameCenter.Rows[0]["ValidateReceivedData"].ToString());
                        ClickService.chbDecreasePriceInLevel2 = Convert.ToBoolean(byGameCenter.Rows[0]["IsDecreasePriceInLevel2"].ToString());
                        ClickService.chbShowAllRecive = Convert.ToBoolean(byGameCenter.Rows[0]["IsShowAllRecive"].ToString());
                        ClickService._checkBoxShowAll = Convert.ToBoolean(byGameCenter.Rows[0]["IsShowAllRecive"].ToString());
                        ClickService.chbShowAllSend = Convert.ToBoolean(byGameCenter.Rows[0]["IsShowAllSend"].ToString());
                        this.WriteToFile("txtServerIp:" + ClickService.txtServerIp + ",chbAP1:" + ClickService.chbAP1.ToString() + ",txtAp1_IP:" + ClickService.txtAp1_IP + ",chbAP2:" + ClickService.chbAP2.ToString() + ",txtAp2_IP:" + ClickService.txtAp2_IP + ",cblRepeatConfig:" + (object)ClickService.cblRepeatConfig + "cblValidateReceivedData:" + (object)ClickService.cblValidateReceivedData + ",chbDecreasePriceInLevel2:" + ClickService.chbDecreasePriceInLevel2.ToString() + ",chbShowAllRecive:" + ClickService.chbShowAllRecive.ToString() + ",chbShowAllSend:" + ClickService.chbShowAllSend.ToString());
                    }
                    else
                    ...
                    ClickService.flagConnectToSQL = true;
                    try
                    {
                        ClickService.TCp_IP_Thread_1.Interrupt();
                        ClickService.TCp_IP_Thread_1.Abort();
                    }
                    catch (Exception ex)
                    {
                    }
                    try
                    {
                        ClickService.TCp_IP_Thread_2.Interrupt();
                        ClickService.TCp_IP_Thread_2.Abort();
                    }
                    catch (Exception ex)
                    {
                    }
                    try
                    {
                        ClickService.txtServerIp = ClickService.GetLocalIPAddress();
                    }
                    catch
                    {
                        ClickService.txtServerIp = "";
                    }
                    ClickService.TCP_RepeatCount = ClickService.cblRepeatConfig;
                    ClickService.TCP_CountValidateReceivedData = ClickService.cblValidateReceivedData;
                    this.objSwiper.Swiper_Update_Config_StateByGameCenterID(this.objMain.ID_GameCenter_Local_Get(), 0);
                    ClickService.TCP_CountValidateReceivedData = ClickService.cblValidateReceivedData;
                    ClickService.IpAp1 = "";
                    ClickService.IpAp2 = "";
                    if (ClickService.chbAP1)
                    {
                        try
                        {
                            ClickService.IpAp1 = ClickService.txtAp1_IP;
                            ClickService.TCp_IP_Thread_1 = new Thread(new ThreadStart(this.Recive_StartTcpIp_1));
                            ClickService.TCp_IP_Thread_1.Start();
                        }
                        catch
                        {
                        }
                    }
                    if (ClickService.chbAP2)
                    {
                        try
                        {
                            ClickService.IpAp2 = ClickService.txtAp2_IP;
                            ClickService.TCp_IP_Thread_2 = new Thread(new ThreadStart(this.Recive_StartTcpIp_2));
                            ClickService.TCp_IP_Thread_2.Start();
                        }
                        catch
                        {
                        }
        ...
        private void OnElapsedTime(object source, ElapsedEventArgs e)
        {
            if (ClickService.chbAP1)
            {
                try
                {
                    if (this.Send_Main(ClickService.IpAp1, "check", ClickService.clientAp1) == 1)
                    {
            ...
            if (ClickService.chbAP2)
            {
                try
                {
                    if (this.Send_Main(ClickService.IpAp2, "check", ClickService.clientAp2) == 1)
                    {
            ...
            if (!ClickService.flagConnectToSQL)
                this.AppLoadMain();
            if (!ClickService.flagConnectToSQL)
                return;
            try
        ...
        {
            ClickService.DispStringRecive = "";
            ClickService.DispStringSplit = "";
            try
            {
                int port = 1000;
                ...
                while (true)
                {
                    try
                    {
                        ClickService.clientAp1 = new TcpClient();
                    }
                    catch
                    {
                    ...
                    ClickService.clientAp1.Connect(ClickService.IpAp1, port);
                    ClickService.TCPIpState_Main1 = true;
                    str1 = (string)null;
                    NetworkStream stream = ClickService.clientAp1.GetStream();
                    try
                    {
                        int count;
                        while ((uint)(count = stream.Read(numArray, 0, numArray.Length)) > 0U)
                        {
                            ...
                            try
                            {
                                ...
                                ClickService.DispStringRecive += str2;
                                try
                                {
                                    string[] strArray = ClickService.DispStringRecive.Split('[');
                                    for (int index = 0; index < strArray.Length; ++index)
                                    {
                                        ClickService.DispStringSplit = strArray[index].Trim();
                                        if (ClickService.DispStringSplit.Length > 0)
                                        {
                                            ClickService.DispStringSplit = "[" + strArray[index].Trim();
                                            ClickService.DispStringReciveTime = DateTime.Now;
                                            if (this.Process_ReciveData(ClickService.DispStringSplit, 1) == "true")
                                                this.Recive_DisplayText(ClickService.DispStringSplit, "P1");
                                            else if (ClickService._checkBoxShowAll)
                                                this.Recive_DisplayText(ClickService.DispStringSplit, "P1");
                                        }
                                    }
                                }
        ...
        {
            ClickService.DispStringRecive_T2 = "";
            ClickService.DispStringSplit_T2 = "";
            try
            {
                int port = 1000;
                byte[] numArray = new byte[256];
                ...
                while (true)
                {
                    try
                    {
                        ClickService.clientAp2 = new TcpClient();
                    }
                    catch
                    {
                    ...
                    ClickService.clientAp2.Connect(ClickService.IpAp2, port);
                    ClickService.TCPIpState_Main2 = true;
                    str1 = (string)null;
                    NetworkStream stream = ClickService.clientAp2.GetStream();
                    try
                    {
                        int count;
                        while ((uint)(count = stream.Read(numArray, 0, numArray.Length)) > 0U)
                        {
                            ...
                            {
                                string str2 = Encoding.ASCII.GetString(numArray, 0, count).Replace("\n", "");
                                ClickService.DispStringRecive_T2 += str2;
                                try
                                {
                                    string[] strArray = ClickService.DispStringRecive_T2.Split('[');
                                    for (int index = 0; index < strArray.Length; ++index)
                                    {
                                        ClickService.DispStringSplit_T2 = strArray[index].Trim();
                                        if (ClickService.DispStringSplit_T2.Length > 0)
                                        {
                                            ClickService.DispStringSplit_T2 = "[" + strArray[index].Trim();
                                            ClickService.DispStringReciveTime_T2 = DateTime.Now;
                                            if (this.Process_ReciveData(ClickService.DispStringSplit_T2, 2) == "true")
                                                this.Recive_DisplayText(ClickService.DispStringSplit_T2, "P2");
                                            else if (ClickService._checkBoxShowAll)
                                                this.Recive_DisplayText(ClickService.DispStringSplit_T2, "P2");
                                        }
                                    }
        ...
        {
            if (ClickService.txtRecive.Length > 10000)
            {
                ClickService.txtRecive = "";
                ClickService.txtSend = "";
            }
            if (!ClickService.chbShowAllRecive)
            {
                if (ClickService.txtRecive.Contains(ReciveData))
                    return;
                this.WriteToFile_SendRecive(TcpIPName + "-" + (object)ClickService.DispStringReciveTime.Hour + ":" + (object)ClickService.DispStringReciveTime.Minute + ":" + (object)ClickService.DispStringReciveTime.Second + ":" + (object)ClickService.DispStringReciveTime.Millisecond + "-" + ReciveData, 2, ClickService.DispStringReciveTime);
                ClickService.txtRecive = ClickService.txtRecive + TcpIPName + "-" + (object)ClickService.DispStringReciveTime.Hour + ":" + (object)ClickService.DispStringReciveTime.Minute + ":" + (object)ClickService.DispStringReciveTime.Second + ":" + (object)ClickService.DispStringReciveTime.Millisecond + "-" + ReciveData;
            }
            else
            {
                this.WriteToFile_SendRecive(TcpIPName + "-" + (object)ClickService.DispStringReciveTime.Hour + ":" + (object)ClickService.DispStringReciveTime.Minute + ":" + (object)ClickService.DispStringReciveTime.Second + ":" + (object)ClickService.DispStringReciveTime.Millisecond + "-" + ReciveData, 2, ClickService.DispStringReciveTime);
        ...
        private void Timer_SendData_Tick(object sender, EventArgs e)
        {
            ...
            for (int index1 = 0; index1 < storageGetForSend.Rows.Count; ++index1)
            {
                ...
                if (!(str1 == ""))
                {
                    ...
                    int tcpRepeatCount = ClickService.TCP_RepeatCount;
                    ...
                    if (str2.Contains("HIDShow$"))
                    {
                        ...
                        {
                            this.Send_Main(ClickService.IpAp1, Command1, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command1, ClickService.clientAp2);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command2, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command2, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command3, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command3, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command4, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command4, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command5, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command5, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command6, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command6, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command7, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command7, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command8, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command8, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command9, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command9, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command10, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command10, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command11, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command11, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command12, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command12, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command13, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command13, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command14, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command14, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command15, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command15, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command16, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command16, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command17, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command17, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command18, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command18, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command19, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command19, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command20, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command20, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command21, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command21, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command22, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command22, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command23, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command23, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command24, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command24, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command25, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command25, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command26, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command26, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command27, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command27, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                        Thread.Sleep(millisecondsTimeout1);
                        ...
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            this.Send_Main(ClickService.IpAp1, Command28, ClickService.clientAp1);
                            this.Send_Main(ClickService.IpAp2, Command28, ClickService.clientAp2);
                            Thread.Sleep(millisecondsTimeout2);
                        }
                    }
                    else
                    {
                        for (int index2 = 0; index2 < tcpRepeatCount; ++index2)
                        {
                            ClickService.DispStringSendTime = DateTime.Now;
                            this.Send_DisplayText(str2, "P1", t_SwiperName, t_CardmacAddress);
                            this.Send_Main(ClickService.IpAp1, str2, ClickService.clientAp1);
                            Thread.Sleep(10);
                            ClickService.DispStringSendTime = DateTime.Now;
                            this.Send_DisplayText(str2, "P2", t_SwiperName, t_CardmacAddress);
                            this.Send_Main(ClickService.IpAp2, str2, ClickService.clientAp2);
                            Thread.Sleep(5);
                        }
                    }
                    ...
                    for (int index2 = 0; index2 < byState.Rows.Count; ++index2)
                    {
                        ...
                        for (int index3 = 0; index3 < ClickService.TCP_RepeatCount + 2; ++index3)
                        {
                            this.Send_DisplayText(str2, "P1", "", "");
                            this.Send_Main(ClickService.IpAp1, Command, ClickService.clientAp1);
                            Thread.Sleep(100);
                            this.Send_DisplayText(str2, "P2", "", "");
                            this.Send_Main(ClickService.IpAp2, Command, ClickService.clientAp2);
                        }
                    }
                    try
                    {
                        if (ClickService.DispStringRecive.ToUpper().Contains("[KA=") || ClickService.DispStringRecive.ToLower().Contains("selftest"))
                        {
                            ...
                            for (int index2 = 0; index2 < stateForChangePrice.Rows.Count; ++index2)
                            {
                                ...
                                if (addressByChargeRate.Rows.Count > 0)
                                {
                                    ...
                                    for (int index3 = 0; index3 < ClickService.TCP_RepeatCount + 5; ++index3)
                                    {
                                        this.Send_DisplayText(str4, "P1", "", "");
                                        this.Send_Main(ClickService.IpAp1, str4, ClickService.clientAp1);
                                        Thread.Sleep(70);
                                        this.Send_DisplayText(str4, "P2", "", "");
                                        this.Send_Main(ClickService.IpAp2, str4, ClickService.clientAp2);
                                    }
                                    Thread.Sleep(100);
                                    for (int index3 = 0; index3 < ClickService.TCP_RepeatCount + 5; ++index3)
                                    {
                                        this.Send_DisplayText(str5, "P1", "", "");
                                        this.Send_Main(ClickService.IpAp1, str5, ClickService.clientAp1);
                                        Thread.Sleep(70);
                                        this.Send_DisplayText(str5, "P2", "", "");
                                        this.Send_Main(ClickService.IpAp2, str5, ClickService.clientAp2);
                                    }
                                }
                            }
                        }
            ...
            try
            {
                    ...
                    if (ReciveText.Contains("OKCFG"))
                    {
                        ...
                        if (addressByChargeRate.Rows.Count > 0)
                        {
                            ...
                            if (ReciveText.Contains("OKCFG1"))
                            {
                                ...
                                ClickService.MyReport = "موفقیت در ثبت تایم استمپ /r/n";
                            ...
                            {
                                ClickService.MyReport = "موفقیت در ثبت نام دستگاه /r/n";
                            ...
                            if (ReciveText.Contains("OKCFG3"))
                            {
                                if (num1 != -3)
                                {
                                    ClickService.MyReport = "موفقیت در ثبت نام قیمت عادی /r/n";
                            ...
                            if (ReciveText.Contains("OKCFG4"))
                            {
                                if (num1 != -3)
                                {
                                    ClickService.MyReport = "موفقیت در ثبت نام قیمت ویژه /r/n";
                            ...
                            if (ReciveText.Contains("OKCFG5"))
                            {
                                ...
                                ClickService.MyReport = "موفقیت در ثبت نام Delay و TimeOut /r/n";
                            ...
                            if (ReciveText.Contains("OKCFG6"))
                            {
                                try
                                {
                                    ...
                                    if (str7 == "1")
                                    {
                                        ...
                                        ClickService.MyReport = "تنظیمات پایه با موفقیت انجام یافت";
                                    }
                                    if (str7 == "2")
                                    {
                                    ...
                                    if (!boolean)
                                    {
                                        ...
                                        if (tuple.Item1)
                                        {
                                            ...
                                            if (tuple.Item6)
                                            {
                                                ...
                                                if (!ClickService.chbDecreasePriceInLevel2)
                                                {
                                                    int num8 = this.objcard.Card_Play_Details_Insert(str8, 0, 0, ClickService.Main_ID_GameCenter, str6, num5, 0, 0, IsPersonnel, num1, ID_Swiper, ID_Play_Type, 0, 0, 0, empty);
                                        ...
                                        if (!flag4)
                                        {
                                            ...
                                            if (flag6 | flag5)
                                            {
                                                ...
                                                if (!ClickService.chbDecreasePriceInLevel2)
                                                {
                                                    int num10 = this.objcard.Card_UpdatePriceAndBonus_PlayDetails2(str8, num8, num9, ClickService.Main_ID_GameCenter, str6, num5, num8, num9, IsPersonnel, num1, ID_Swiper, ID_Play_Type, 0, 0, 0, empty);
                                            ...
                                            else
                                            {
                                                ...
                                                if (num8 + num9 + Pay_GiftPortion + num6 >= num5)
                                                {
                                                    ...
                                                    if (!ClickService.chbDecreasePriceInLevel2)
                                                    {
                                                        ...
                                                        if (num8 >= num11)
                                                        {
                                                            int num12 = this.objcard.Card_UpdatePriceAndBonus_PlayDetails2(str8, num8 - num11, num9, ClickService.Main_ID_GameCenter, str6, num5, num8 - num11, num9, IsPersonnel, num1, ID_Swiper, ID_Play_Type, num5, 0, Pay_GiftPortion, empty);
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            int num13 = this.objcard.Card_UpdatePriceAndBonus_PlayDetails2(str8, 0, num12, ClickService.Main_ID_GameCenter, str6, num5, 0, num12, IsPersonnel, num1, ID_Swiper, ID_Play_Type, num5 - Pay_BonusPortion, Pay_BonusPortion, Pay_GiftPortion, empty);
                            ...
                            if (addressByChargeRate.Rows.Count > 0)
                            {
                                ...
                                if (byMacAddrress.Rows.Count > 0)
                                {
                                    ...
                                    if (tuple.Item1)
                                    {
                                        if (tuple.Item6)
                                        {
                                            int num8 = this.objcard.Card_Play_Details_Insert(str8, 0, 0, ClickService.Main_ID_GameCenter, str6, num6, 0, 0, IsPersonnel, num2, ID_Swiper, ID_Play_Type, 0, 0, 0, empty);
                                    ...
                                    if (!flag3)
                                    {
                                        ...
                                        if (flag5 | flag4)
                                        {
                                            int num10 = this.objcard.Card_UpdatePriceAndBonus_PlayDetails2(str8, num8, num9, ClickService.Main_ID_GameCenter, str6, num6, num8, num9, IsPersonnel, num2, ID_Swiper, ID_Play_Type, 0, 0, 0, empty);
                                        ...
                                        else
                                        {
                                            ...
                                            if (num8 + num9 + Pay_GiftPortion + num7 >= num6)
                                            {
                                                ...
                                                if (num8 >= num10)
                                                {
                                                    int num11 = this.objcard.Card_UpdatePriceAndBonus_PlayDetails2(str8, num8 - num10, num9, ClickService.Main_ID_GameCenter, str6, num6, num8 - num10, num9, IsPersonnel, num2, ID_Swiper, ID_Play_Type, num6, 0, Pay_GiftPortion, empty);
                                                ...
                                                else
                                                {
                                                    ...
                                                    int num12 = this.objcard.Card_UpdatePriceAndBonus_PlayDetails2(str8, 0, num11, ClickService.Main_ID_GameCenter, str6, num6, 0, num11, IsPersonnel, num2, ID_Swiper, ID_Play_Type, num6 - Pay_BonusPortion, Pay_BonusPortion, Pay_GiftPortion, empty);
                            ...
                            if (byMacAddrress.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (int.Parse(byMacAddrress.Rows[0]["ID_Card_Series"].ToString()) == 3)
                                        IsPersonnel = 1;
                                    DataTable byCardGuid = this.objcard.Card_Play_Details_GetByCardGUID(str6, Card_GUID, ClickService.Main_ID_GameCenter);
                                    ...
                                    if (!flag1)
                                    {
                                        ...
                                        if (ID_Card_Play_Details > 0)
                                        {
                                            if (str11.ToUpper() == "E")
                                            {
                                                ...
                                                int ID_Games_Ticket = this.objMain.Games_Ticket_Insert(ClickService.Main_ID_GameCenter, str6, str7, Count, Status, ID_Card_Play_Details, Card_GUID, IsPersonnel, ID_Games, ID_Swiper);
                                                if (str9 == "3")
                                                {
                                                    if (IsPersonnel == 0)
                                                    {
                                                        if (this.objcard.Card_Ticket_History_insert(ClickService.Main_ID_GameCenter, -1, Count, Card_GUID, OldCount, 6, ID_Games_Ticket) > 0)
                                                        {
                                            ...
                                            if (str11.ToUpper() == "O")
                                            {
                                                ...
                                                if (IsPersonnel == 0)
                                                {
                                                    ...
                                                    else if (str9 == "3" && this.objcard.Card_Ticket_History_insert(ClickService.Main_ID_GameCenter, -1, Count, Card_GUID, OldCount, 6, ID_Games_Ticket) > 0)
                                                    {
                                                        if (this.objcard.Card_SetEtickets(Card_GUID, Count + OldCount) > 0)
                                                        {
                                                            int num = Count + OldCount;
                                        ...
                                        {
                                            this.objMain.Games_Ticket_Insert(ClickService.Main_ID_GameCenter, str6, str7, Count, 3, ID_Card_Play_Details, Card_GUID, IsPersonnel, ID_Games, ID_Swiper);
                                            str1 = "[" + str8 + "]AT+TRC=0";
                                            str2 = "[" + str8 + "]AT+TRC=0";
                                        }
                                    }
                ...
                try
                {
                    if (ReciveText.Contains("Error_conf"))
                    {
                        string str5 = ReciveText.Substring(1, 12);
                        string str6 = str5.Substring(0, 2) + str5.Substring(3, 2) + str5.Substring(6, 2) + str5.Substring(9, 2);
                        string timeStamp = ClickService.TimeStamp;
                        string MacAddress = str6;
          ...
          string t_CardmacAddress)
        {
            ...
            if (!ClickService.chbShowAllSend)
            {
                if (SendData.Length <= 0 || ClickService.txtSend.Contains(TcpIPName + "-" + SendData))
                    return;
                this.WriteToFile_SendRecive(TcpIPName + "-" + (object)ClickService.DispStringSendTime.Hour + ":" + (object)ClickService.DispStringSendTime.Minute + ":" + (object)ClickService.DispStringSendTime.Second + ":" + (object)ClickService.DispStringSendTime.Millisecond + "-" + SendData + "-" + t_SwiperName + "-" + t_CardmacAddress, 1, ClickService.DispStringSendTime);
                ClickService.txtSend = ClickService.txtSend + TcpIPName + "-" + SendData + (object)ClickService.DispStringSendTime.Hour + ":" + (object)ClickService.DispStringSendTime.Minute + ":" + (object)ClickService.DispStringSendTime.Second + ":" + (object)ClickService.DispStringSendTime.Millisecond + "-" + t_SwiperName + t_CardmacAddress;
            }
