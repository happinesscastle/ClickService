...
namespace ClickServerService
{
    ...
    {
        private readonly SwiperClass clsSwiper = new SwiperClass();
        ...
        public DataTable Charge_Rate_GetAll(int ID_GameCenter)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID_Days", clsSwiper.RetDayOfWeek());
                    sqlCommand.Parameters.AddWithValue("@ID_GameCenter", ID_GameCenter);
                    sqlCommand.ExecuteNonQuery();
                    //Run (Update Swipers List) in ClsStarter Timer 1H 
                }
                return dataTable;
            }
            catch (Exception ex)
        ...
        public int Games_Groups_Update(int ID, string Title)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Groups_Update", connection) { CommandType = CommandType.StoredProcedure };
        ...
        public DataTable Games_Groups_Get(int ID)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("Games_Groups_Get", connection) { CommandType = CommandType.StoredProcedure };
        ...
        public int Games_Groups_Delete(int ID)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Groups_Delete", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.ExecuteNonQuery();
                }
                return 1;
        ...
        public int Games_Type_Update(int ID, string Title)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Type_Update", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.ExecuteNonQuery();
                }
        ...
        public DataTable Games_Type_Get(int ID)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("Games_Type_Get", connection) { CommandType = CommandType.StoredProcedure };
                    selectCommand.Parameters.AddWithValue("@ID", ID);
                    new SqlDataAdapter(selectCommand).Fill(dataTable);
                }
                return dataTable;
        ...
        public int Games_Type_Delete(int ID)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Type_Delete", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.ExecuteNonQuery();
                }
                return 1;
        ...
        public int Games_Class_Update(int ID, string Title, string Des, int ID_Games_Group, int ID_Games_Type, int IsStock, int IsFreeGames, int IsFreeDayliGames, int IsBonusAllowed)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Class_Update", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
        ...
        public DataTable Games_Class_Get(int ID)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("Games_Class_Get", connection) { CommandType = CommandType.StoredProcedure };
                    selectCommand.Parameters.AddWithValue("@ID", ID);
                    new SqlDataAdapter(selectCommand).Fill(dataTable);
                }
                return dataTable;
        ...
        public int Games_Class_Delete(int ID)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Class_Delete", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.ExecuteNonQuery();
                }
                return 1;
        ...
        public int ChargeGroup_Update(int ID, string Title)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("ChargeGroup_Update", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.ExecuteNonQuery();
                }
        ...
        public DataTable ChargeGroup_Get(int ID)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("ChargeGroup_Get", connection) { CommandType = CommandType.StoredProcedure };
                    selectCommand.Parameters.AddWithValue("@ID", ID);
                    new SqlDataAdapter(selectCommand).Fill(dataTable);
                }
                return dataTable;
        ...
        public int ChargeGroup_Delete(int ID)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("ChargeGroup_Delete", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.ExecuteNonQuery();
                }
                return 1;
        ...
        public DataTable Charge_Rate_Get(int ID_ChargeGroup, int ID_Days, int ID_Card_Status)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("Charge_Rate_Get", connection) { CommandType = CommandType.StoredProcedure };
        ...
        public int Days_Special_Update(int ID, string Title, DateTime DaysDate, int ID_SpecialDays_Type)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Days_Special_Update", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
        ...
        public DataTable Days_Special_Get(int ID)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("Days_Special_Get", connection) { CommandType = CommandType.StoredProcedure };
                    selectCommand.Parameters.AddWithValue("@ID", ID);
                    new SqlDataAdapter(selectCommand).Fill(dataTable);
                }
                return dataTable;
        ...
        public int Days_Special_Delete(int ID)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Days_Special_Delete", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.ExecuteNonQuery();
                }
                return 1;
        ...
        public int Games_Update(int ID, int ID_GameCenter, string Code, string Title, string Des, int ID_Game_Type, int ID_ChargeGroup, int ID_Games_Groups, int ID_Games_Class, string CountOfTicket, int IsRetired, int IsETicket, int IsPaperTicket, int IsStock, int IsFreeGames, int IsFreeDailyGames, int IsBonus)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Update", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.Parameters.AddWithValue("@ID_GameCenter", ID_GameCenter);
        ...
        public DataTable Games_Get(int ID)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("Games_Get", connection) { CommandType = CommandType.StoredProcedure };
                    selectCommand.Parameters.AddWithValue("@ID", ID);
                    new SqlDataAdapter(selectCommand).Fill(dataTable);
                }
                return dataTable;
        ...
        public int Games_Delete(int ID)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Games_Delete", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.ExecuteNonQuery();
                }
                return 1;
        ...
        public int Bonuses_Update(int ID, string Title, bool IsAccumulativeBalance, bool IsRunningAccumulativeBalance, bool IsAmountTendered, int FromPrice, int ToPrice, int BonusType, int Bonus, int FreeGame, int FreeGameDaily, int ProductID, int WhenID, string CardStatusIDs, bool IsReportToCashier, bool IsPromptToRegister, string Message, int ID_GameCenter)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Bonuses_Update", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
        ...
        public DataTable Bonuses_Get(int ID)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand selectCommand = new SqlCommand("Bonuses_Get", connection) { CommandType = CommandType.StoredProcedure };
                    selectCommand.Parameters.AddWithValue("@ID", ID);
                    new SqlDataAdapter(selectCommand).Fill(dataTable);
                }
                return dataTable;
        ...
        public int Bonuses_Delete(int ID)
        {
            try
            {
                ...
                {
                    connection.Open();
                    SqlCommand sqlCommand = new SqlCommand("Bonuses_Delete", connection) { CommandType = CommandType.StoredProcedure };
                    sqlCommand.Parameters.AddWithValue("@ID", ID);
                    sqlCommand.ExecuteNonQuery();
                }
                return 1;
        ...
        public int Games_Groups_insert(string Title)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID", (clsMain.Max_Tbl("Games_Groups", "ID") + 1));
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
        ...
        public int Games_Type_insert(string Title)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID", (clsMain.Max_Tbl("Games_Type", "ID") + 1));
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.Parameters.AddWithValue("@IsDeleted", 0);
                    sqlCommand.CommandType = CommandType.StoredProcedure;
                    sqlCommand.ExecuteNonQuery();
        ...
        public int Games_Class_insert(string Title, string Des, int ID_Games_Group, int ID_Games_Type, int IsStock, int IsFreeGames, int IsFreeDayliGames, int IsBonusAllowed)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID", (clsMain.Max_Tbl("Games_Class", "ID") + 1));
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.Parameters.AddWithValue("@Des", Des);
                    sqlCommand.Parameters.AddWithValue("@ID_Games_Group", ID_Games_Group);
                    sqlCommand.Parameters.AddWithValue("@ID_Games_Type", ID_Games_Type);
        ...
        public int ChargeGroup_insert(string Title)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID", (clsMain.Max_Tbl("ChargeGroup", "ID") + 1));
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.Parameters.AddWithValue("@IsDeleted", 0);
                    sqlCommand.ExecuteNonQuery();
                }
        ...
        public int Days_Special_insert(string Title, DateTime DaysDate, int ID_SpecialDays_Type)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID", (clsMain.Max_Tbl("Days_Special", "ID") + 1));
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.Parameters.AddWithValue("@DaysDate", DaysDate);
                    sqlCommand.Parameters.AddWithValue("@ID_SpecialDays_Type", ID_SpecialDays_Type);
                    sqlCommand.ExecuteNonQuery();
        ...
        public int Games_insert(int ID_GameCenter, string Code, string Title, string Des, int ID_Game_Type, int ID_ChargeGroup, int ID_Games_Groups, int ID_Games_Class, string CountOfTicket, int IsRetired, int IsETicket, int IsPaperTicket, int IsStock, int IsFreeGames, int IsFreeDailyGames, int IsBonus)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID", (clsMain.Max_Tbl("Games", "ID") + 1));
                    sqlCommand.Parameters.AddWithValue("@ID_GameCenter", ID_GameCenter);
                    sqlCommand.Parameters.AddWithValue("@Code", Code);
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.Parameters.AddWithValue("@Des", Des);
        ...
        public int Bonuses_insert(string Title, bool IsAccumulativeBalance, bool IsRunningAccumulativeBalance, bool IsAmountTendered, int FromPrice, int ToPrice, int BonusType, int Bonus, int FreeGame, int FreeGameDaily, int ProductID, int WhenID, string CardStatusIDs, bool IsReportToCashier, bool IsPromptToRegister, string Message, int ID_GameCenter)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(clsMain.DBPath()))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@ID", (clsMain.Max_Tbl("Bonuses", "ID") + 1));
                    sqlCommand.Parameters.AddWithValue("@Title", Title);
                    sqlCommand.Parameters.AddWithValue("@IsAccumulativeBalance", IsAccumulativeBalance);
                    sqlCommand.Parameters.AddWithValue("@IsRunningAccumulativeBalance", IsRunningAccumulativeBalance);
                    sqlCommand.Parameters.AddWithValue("@IsAmountTendered", IsAmountTendered);
